...
describe("GoalNode", () => {
	...
	describe("Basic Rendering", () => {
		...
		it("should have proper shadow and border radius", () => {
			...
			const nodeContainer = screen.getByText("Test Goal").closest(".shadow-md");
	...
	describe("Child Components", () => {
		...
		it("should pass node props to ToggleButton", () => {
			...
			renderWithReactFlowAndAuth(<GoalNode data={data} {...customProps} />);
	...
	describe("Layout and Positioning", () => {
		...
		it("should have proper text container width", () => {
			...
			const nameElement = screen.getByText("Test Goal");
