...
/**
 * Comment, tree node, and top-level export envelope for the nested export
 * format (v1.0) — re-exported from lib/schemas/case-export.ts.
 *
 ...
 * Zod schema and every real export never had).
 */
export type {
	CaseExportNested,
	ExportComment,
