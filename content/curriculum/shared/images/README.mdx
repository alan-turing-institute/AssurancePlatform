...
**Module-specific images** should be stored in the `public/` directory and referenced appropriately.
...
Images in this directory should be copied to `/public/` for use in documentation, or referenced via appropriate paths.
