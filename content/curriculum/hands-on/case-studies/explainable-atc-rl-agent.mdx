...
### Attention-Based Architectures and Intrinsic Interpretability
...
- [Brittain, M. W. et al. (2024) "Improving Autonomous Separation Assurance through Distributed Reinforcement Learning with Attention Networks"](https://doi.org/10.1609/aaai.v38i21.30321) — Introduces the use of attention networks with soft actor-critic RL for aircraft separation assurance; the attention mechanism provides intrinsic interpretability by revealing which surrounding aircraft influence each decision
