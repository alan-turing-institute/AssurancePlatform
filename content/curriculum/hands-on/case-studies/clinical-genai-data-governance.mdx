...
The Greater Manchester Integrated Care System (GM ICS) has deployed a Generative AI-powered clinical decision support system to assist clinicians in managing patients with complex, multi-morbid conditions. The system—called ClinAssist—analyses patient records and generates natural language summaries, identifies potential care gaps, suggests evidence-based interventions, and drafts clinical correspondence.

ClinAssist was trained on 15 years of electronic health records from across Greater Manchester, comprising over 3 million patient journeys. However, these records were collected under consent frameworks that permitted data use for "improving the quality of care" and "healthcare research"—terms that predate the emergence of large language models and generative AI. Patients did not specifically consent to their data being used to train AI systems that generate novel content.

Following concerns raised by patient advocacy groups and the local Healthwatch organisation, GM ICS has commissioned an assurance case to demonstrate that ClinAssist operates transparently, with appropriate accountability for its use of patient data and clear communication to patients about how their information contributes to AI-assisted care.
...
| **Training Data** | 3.2 million patient records (2008-2023) from GM ICS; clinical guidelines from NICE, royal colleges, and specialist societies; medical literature corpus |
...
- **Coverage**: All 10 localities within Greater Manchester ICS, serving 2.8 million residents
...
- **Query Volume**: ~25,000 clinical queries daily
- **Patient Records Accessed**: 3.2 million patient records in training; ~50,000 individual records accessed daily for inference
...
- **UK GDPR and Data Protection Act 2018**: Lawful basis for processing (consent, legitimate interests, or public task); purpose limitation principle; transparency requirements; Article 22 rights regarding automated decision-making
- **Common Law Duty of Confidentiality**: Patients' reasonable expectations about how their health information will be used
- **NHS Act 2006 (as amended)**: Section 251 provisions for using patient data without consent for medical purposes in certain circumstances
...
- [Data Lineage Tracking](https://alan-turing-institute.github.io/tea-techniques/techniques/data-lineage-tracking/) - Document the flow of patient data through training and inference pipelines, enabling transparency about data provenance
...
- [Retrieval Attribution](https://alan-turing-institute.github.io/tea-techniques/techniques/retrieval-attribution/) - For RAG systems, provide clear citations showing which source documents influenced generated responses
- [Membership Inference Testing](https://alan-turing-institute.github.io/tea-techniques/techniques/membership-inference-testing/) - Assess privacy risks by testing whether specific patient records can be identified as having been in training data
- [Stakeholder Impact Assessment](https://alan-turing-institute.github.io/tea-techniques/techniques/stakeholder-impact-assessment/) - Systematically analyse impacts on different patient groups and stakeholders to inform transparency communications
...
- [use MY data: Patient Perspectives on Health Data Use](https://www.usemydata.org/)
