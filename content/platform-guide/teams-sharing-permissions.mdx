...
A team grant is evaluated against current membership, so a member added later inherits it. Review membership practices before granting a team Admin case access.
</Callout>
...
- `components/sharing/_case-sharing/permission-components.tsx`
...
- `app/(authenticated)/dashboard/teams/page.tsx`
- `lib/permissions.ts`
