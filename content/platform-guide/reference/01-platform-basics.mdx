...
* **Documentation**: Comprehensive guides in [TEA Trainee](/docs/curriculum/tea-trainee)
* **Community**: Questions and discussions in [Community](/docs/community)
* **Glossary**: Term definitions in [Glossary](./glossary)

<Callout type="info">
**In-Depth Learning**

This is a quick reference. For detailed tutorials, see the [TEA Trainee curriculum](/docs/curriculum/tea-trainee).
</Callout>
