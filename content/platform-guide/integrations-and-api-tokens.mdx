...
Token lifetime depends on an optional expiry supplied at issue time. Tokens issued without one remain valid until revoked or rotated; check the integration's token policy before relying on an expiry.
</Callout>
...
- `app/(authenticated)/dashboard/settings/integrations/_components/integration-register-dialog.tsx`
- `app/(authenticated)/dashboard/settings/integrations/_components/integration-card.tsx`
- `app/(authenticated)/dashboard/settings/integrations/_components/integration-scope-labels.ts`
- `lib/auth/scopes.ts`
...
- `app/(authenticated)/dashboard/settings/integrations/_components/grant-case-access-form.tsx`
- `app/(authenticated)/dashboard/settings/integrations/_components/integration-delete-dialog.tsx`
