...
- **Customisation**: Highly customisable with a configuration file that allows you to set up your design system (colours, spacing, typography, etc.).
...
### Customisation
Tailwind CSS is highly customisable. You can extend the default theme by modifying the `tailwind.config.js` file. For example, to add custom colors:
