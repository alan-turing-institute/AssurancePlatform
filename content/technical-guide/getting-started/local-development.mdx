...
A quicker way to get the TEA Platform running on your local machine is to use Docker. If you're familiar with Docker and docker-compose, you can follow the [Docker Quickstart guide](./docker-quickstart) to set up the platform with minimal effort.
</Callout>
