...
| `TOKEN_ENCRYPTION_KEY` | Base64-encoded 32-byte key used to encrypt stored GitHub/Google OAuth tokens at rest (AES-256-GCM) | Generate with `openssl rand -base64 32` |
