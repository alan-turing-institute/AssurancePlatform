...
server {
    ...
    # Match the app's largest request-body limit (screenshot/case-import
    # uploads, capped at 10 MiB — see lib/api-request.ts). nginx's own
    # default is 1m, which would reject those uploads at the proxy before
