...
The TEA Platform is currently in research preview with version **v0.3.0**.
...
- **`main`** - Production releases (e.g., `v0.3.0`)
- **`staging`** - Pre-production integration (e.g., `v0.3.0-dev.20250112.abc123`)
...
#### Development Builds
```bash
# Tagged on staging branch
v0.3.0-dev.20250112.abc123
v0.3.0-dev.20250113.def456
```
...
- **Production**: `ghcr.io/alan-turing-institute/assuranceplatform:v0.3.0`
- **Development**: `ghcr.io/alan-turing-institute/assuranceplatform:v0.3.0-dev.20250112.abc123`
- **Latest**: `ghcr.io/alan-turing-institute/assuranceplatform:latest`

### Branch Aliases

- **`latest`** - Points to the most recent production release
- **`staging`** - Points to the most recent staging build
...
1. **Code pushed to `staging`** triggers staging build
...
- **Production** (`main` branch)
  - Uses stable version tags (e.g., `v0.3.0`)
  - Deployed to production Azure App Services
  - Available at production URLs

- **Staging** (`staging` branch)
  - Uses development version tags (e.g., `v0.3.0-dev.20250112.abc123`)
...
- [Changelog](./changelog) with comprehensive version history
...
For questions about versioning strategy, please refer to the [Technical Documentation](../index) or reach out through our [Community Support](../../community/community-support) channels.
