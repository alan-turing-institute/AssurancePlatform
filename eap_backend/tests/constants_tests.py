...
ARGUMENT1_INFO_NO_ID = {
    "name": "Argument 1",
    "short_description": "This is an argument",
    "long_description": "looong description of the argument",
}
ARGUMENT1_INFO = {
    "name": "Argument 1",
    "short_description": "This is an argument",
...
ARGUMENT2_INFO_NO_ID = {
    "name": "Argument 2",
    "short_description": "This is also an argument",
    "long_description": "looong description of the second argument",
}
ARGUMENT2_INFO = {
    "name": "Argument 2",
    "short_description": "This is also an argument",
...
ARGUMENT3_INFO = {
    "name": "Argument 3",
    "short_description": "Would you believe this is also an argument",
    "long_description": "looong description of the third argument",
}
ARGUMENT3_INFO_WITH_ID = {
    "name": "Argument 3",
    "short_description": "Would you believe this is also an argument",
    "long_description": "looong description of the third argument",
    "property_claim_id": [2],
