 ...
 */
function NotesCaseModal({ caseId, isOpen, onClose } : any) {
  const titleId = useId();
 ...
 */
function CommentSectionInner({ assuranceCaseId, onClose } : any) {
  ...
  const fetchComments = useCallback(async () => {
    const url = `http://localhost:8000/api/comments/${assuranceCaseId}/`;
