  ...
  height: {
    ...
    expanded: {
      ...
      transition: {
        ...
        opacity: { duration: TIMING.normal / 1000, delay: 0.1, ease: EASING.easeIn },
      },
    },
  },
 ...
 * @param {string} category - Preset category (entry, exit, interaction, etc.)
 * @param {string} name - Preset name
 * @returns {object} Animation preset
 */
export const getPreset = (category, name) => {
  const categories = {
  ...
  return categories[category]?.[name] || PRESETS.nodeEntrance;
};

/**
 * Create custom animation preset
 * @param {object} options - Animation options
 * @returns {object} Custom animation preset
 */
 ...
 */
export const mergePresets = (...presets) => {
