...
2. **The TEA Framework**: a set of skills and capabilities resources that help users get the most out of the tool (see [curriculum](./curriculum/index.mdx))
...
A more complete introduction to Trustworthy and Ethical Assurance can be found in our [curriculum](./curriculum/index.mdx) section.
...
You can browse our [curriculum](./curriculum/) or [technical documentation](./technical-guide/) to find out more.
...
<ImageList images={["/img/cfaa-logo.jpg", "/img/dt-hub-logo.jpg"]} />
