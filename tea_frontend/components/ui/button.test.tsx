...
describe('Button', () => {
  ...
  it('should render with different variants', () => {
    const { rerender } = renderWithoutProviders(<Button variant="primary">Primary</Button>)
  ...
  it('should render with different sizes', () => {
    const { rerender } = renderWithoutProviders(<Button size="sm">Small</Button>)
  ...
  it('should have correct accessibility attributes', () => {
    renderWithoutProviders(<Button type="submit" aria-label="Submit form">Submit</Button>)
  ...
  it('should prevent click when disabled', async () => {
    ...
    renderWithoutProviders(<Button disabled onClick={handleClick}>Disabled</Button>)
