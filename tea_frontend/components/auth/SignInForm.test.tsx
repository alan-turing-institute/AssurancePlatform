...
describe('SignInForm', () => {
  ...
  it('should validate maximum username length', async () => {
    ...
    expect(await screen.findByText(/string must contain at most 50 character/i)).toBeInTheDocument()
  })
  ...
  it('should show proper form structure', () => {
    ...
    const usernameField = screen.getByLabelText(/username/i).closest('.space-y-2')
    const passwordField = screen.getByLabelText(/password/i).closest('.space-y-2')
