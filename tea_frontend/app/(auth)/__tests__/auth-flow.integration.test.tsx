...
const USERNAME_EMPTY_REGEX = /username cannot be empty/i;
...
describe('Authentication Flow Integration Tests', () => {
  ...
  describe('User Registration Process', () => {
    ...
    it('should show validation errors for invalid registration data', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(USERNAME_EMPTY_REGEX)).toBeInTheDocument();
      });
    });
    ...
    it('should validate password requirements', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(PASSWORD_REQUIREMENT_REGEX)
        ).toBeInTheDocument();
      });
    });
