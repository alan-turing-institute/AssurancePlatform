      ...
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <div className="mt-16 max-w-3xl">
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-4 text-gray-600">
            <li className="flex gap-x-3">
              <XCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-rose-600" />
              <span>
        ...
        <div className="mt-16 max-w-3xl">
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-emerald-600" />
              <div>
                <strong className="font-semibold text-gray-900">next-auth.csrf-token</strong>
                <ul className='mt-2 space-y-2'>
                  <li><strong className="font-semibold text-gray-900">Purpose:</strong> Helps protect against Cross-Site Request Forgery (CSRF) attacks, enhancing the security of your interactions with the Platform.</li>
                  <li><strong className="font-semibold text-gray-900">Duration:</strong> Session cookie (expires when you close your browser) or for a short, fixed period for security.</li>
                </ul>
              </div>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-emerald-600" />
              <div>
                <strong className="font-semibold text-gray-900">next-auth.callback-url</strong>
                <ul className='mt-2 space-y-2'>
                  <li><strong className="font-semibold text-gray-900">Purpose:</strong> Stores the URL the user was trying to access before being redirected to log in. This allows the Platform to redirect you back to your intended page after successful authentication.</li>
                  <li><strong className="font-semibold text-gray-900">Duration:</strong> Session cookie (expires when you close your browser).</li>
                </ul>
              </div>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-emerald-600" />
              <div>
                <strong className="font-semibold text-gray-900">next-auth.session-token</strong>
                <ul className='mt-2 space-y-2'>
                  <li><strong className="font-semibold text-gray-900">Purpose:</strong> Stores your session information, allowing you to stay logged in as you navigate the Platform. This is fundamental for accessing features available only to registered and authenticated users.</li>
                  <li><strong className="font-semibold text-gray-900">Duration:</strong> This is a session cookie that typically persists for the duration of your browsing session or for a pre-defined secure session length to keep you logged in.</li>
                </ul>
              </div>
            </li>
        ...
        <div className="mt-16 max-w-3xl">
          ...
          <p className="mt-6">
            If you have any questions about our use of cookies or this Cookie Notice, please raise an issue via our GitHub repository: <a href=' https://github.com/alan-turing-institute/AssurancePlatform/issues' className='text-indigo-600 underline'>https://github.com/alan-turing-institute/AssurancePlatform/issues</a>
          </p>
        </div>
