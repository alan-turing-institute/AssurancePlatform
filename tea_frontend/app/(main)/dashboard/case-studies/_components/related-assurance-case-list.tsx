          ...
          <div className="p-4">
            ...
            {assuranceCasesList
              ...
              .map((assuranceCase: AssuranceCase) => (
                <button
                  className={`w-full rounded-md text-left ${selectedAssuranceCases.includes(assuranceCase.id) ? 'bg-indigo-600 text-white hover:bg-indigo-700' : 'hover:bg-gray-100 dark:hover:bg-slate-900'} transition-colors`}
                  ...
                  <div className="mb-2 flex items-center justify-between p-3">
                    ...
                    {selectedAssuranceCases.includes(assuranceCase.id) && (
                      <div className="mt-1 mr-4 flex items-center justify-center gap-2 rounded-full bg-indigo-900/60 px-3 py-2">
                        ...
                        >
                          <title>Selected case checkmark</title>
                          <path
                            clipRule="evenodd"
