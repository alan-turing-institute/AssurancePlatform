    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <p className="mt-6 text-xl/8">
          Introduction regarding what this page is about....
        </p>
        <div className="mt-10 max-w-2xl">
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              ...
              <span>
                <strong className="font-semibold text-gray-900">List Item Example</strong> Lorem ipsum, dolor sit amet
            ...
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
              <span>
                <strong className="font-semibold text-gray-900">List Item Example</strong> Anim aute id magna aliqua ad ad non
            ...
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
              <span>
                <strong className="font-semibold text-gray-900">List Item Example</strong> Ac tincidunt sapien vehicula erat
