...
<CardList>
    <CardComponent title='Card Component' description='Use this card to link to othe pages' url='/documentation/' />
    <CardComponent title='Another Card Component' description='Use this card to link to othe pages' url='/documentation/docs/technical-guide/setup-installation/local-quikstart' />
    <CardComponent title='Third Card Component' description='Use this card to link to othe pages' url='/documentation/' />
</CardList>
