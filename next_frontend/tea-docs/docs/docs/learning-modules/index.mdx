...
# Assurance Skills and Learning Resources

In this section you will find a series of skills and learning resources, designed to help you understand more about TEA and how to use the TEA platform.
...
<CardList>
    <CardComponent title='Co-Developing an Assurance Case' description='This guide has been created to help new teams get up-to-speed quickly with the TEA platform, by building their first assurance case.' url='/documentation/' />
</CardList>
...
<CardList>
    <CardComponent title='Understanding the Assurance Ecosystem' description='An introduction to the broader AI assurance ecosystem' url='./other-modules/assurance-ecosystem.md' />
    <CardComponent title='Standards and their role in assurance' description='An introduction to standards, the different types of standards and their role in assurance' url='./other-modules/tea-trainee.md' />
</CardList>